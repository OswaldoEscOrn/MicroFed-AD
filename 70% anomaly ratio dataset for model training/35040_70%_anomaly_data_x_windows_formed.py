...
try:
    ...
    print(f"✓ Successfully loaded x_windows.npy")
...
print(f"\n📁 Generated files:")
print(f"  1. x_windows.npy - Sliding window data ({X_windows.shape[0]:,} windows)")
...
print(f"\n🔧 Next step:")
print(f"  Now you can use x_windows.npy for model training!")
