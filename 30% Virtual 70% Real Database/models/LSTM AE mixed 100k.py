...
# Data paths - modified to new paths
...
# Model save path - modified to new path
...
# Visualization save path - modified to new path
...
# Feature names - adjusted according to actual data
FEATURE_NAMES = [
